...
class FitPilotApp:
    ...
    def initialize_services(self):
        ...
        try:
            ...
            from app.services.fitness_estimation_service import FitnessEstimationService
            ...
            container.register('fitness_estimation_service', service=FitnessEstimationService(graphql_client))
