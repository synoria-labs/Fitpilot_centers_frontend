...
class DashboardTab(QWidget):
    """Dashboard with 6 real KPI cards + 4 charts + period selector."""
    ...
    def _setup_ui(self) -> None:
        ...
        cards_grid.addWidget(self.card_revenue, 0, 2)
        cards_grid.addWidget(self.card_reservations, 1, 0)
        cards_grid.addWidget(self.card_occupancy, 1, 1)
        cards_grid.addWidget(self.card_new_members, 1, 2)
