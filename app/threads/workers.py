...
class TabLoader(BaseWorker):
    ...
    def _build_tab_descriptor(self) -> Dict[str, Any]:
        tab_mapping = {
            ...
            "owner_agent_config": ("app.views.tabs.owner_agent_config_tab", "OwnerAgentConfigTab"),
            ...
            "fitness_estimation": ("app.views.tabs.fitness_estimation_tab", "FitnessEstimationTab"),
